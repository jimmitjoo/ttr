            ...
            <div class="col-lg-4 col-md-6 center login">
                ...
                <div class="text-center" style="margin-bottom: 10px;">
                    ...
                    <form class="form-horizontal" role="form" method="POST" action="{{ url('/auth/register') }}">
                        ...
                        <input type="text" name="email" placeholder="{{ Lang::get('auth.email') }}" value="{{ old('email') }}"/>
                    ...
                    <div class="col-lg-12 col-md-12 col-xs-12 login-register text-center small">
                        {{ Lang::get('auth.do_you_have_an_account') }} <a href="{{ url('/auth/login') }}">{{ Lang::get('auth.sign_in_here') }}</a>
                    </div>
                </form>
            </div>
        </div>
