    ...
    @foreach($races as $race)
        <div class="row list-item">
            <a href="/lopp/{{ strtolower(urlencode($race->name)) }}/{{ $race->id }}">
                ...
                <div class="col-lg-2 col-md-2 col-xs-3 text-right"><a class="list-btn" href="/lopp/{{ strtolower(urlencode($race->name)) }}/{{ $race->id }}"><span class="hide-mobile">Läs mer</span> &nbsp; <i class="fa fa-long-arrow-right"></i></a></div>
            </a>
        </div>
    @endforeach
